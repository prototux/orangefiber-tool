...
p_geometry="%7B%22xmin%22%3A$g_xmin%2C%22ymin%22%3A$g_ymin%2C%22xmax%22%3A$g_xmax%2C%22ymax%22%3A$g_ymax%2C%22spatialReference%22%3A%7B%22wkid%22%3A102100%7D%7D"
...
cp_url="http://couverture-mobile.orange.fr/arcsig/rest/services/extern/optimum_ftth/MapServer/0/query?token=$p_token&f=$p_format&where=$p_where&returnGeometry=$p_returnGeometry&spatialRel=$p_spatialRel&geometry=$p_geometry&geometryType=$p_geometryType&inSR=$p_inSR&outFields=$p_outFields&outSR=$p_outSR"
